...
export interface Invoice {id:string;reference?:string;onchainId?:`0x${string}`;onchainCreationTxHash?:`0x${string}`;merchantId:string;merchantName:string;merchantPhone:string;network:MobileMoneyNetwork;amountGhs:number;description:string;status:PaymentStatus;expiresAt:string;paymentUrl:string;qrPayload?:string;createdAt?:string;payment?:Payment}
export interface Payment {transactionId:string;invoiceId:string;status:PaymentStatus;blockchainStatus:BlockchainStatus;payoutStatus:PayoutStatus;amountCrypto:string;token:SupportedToken;amountGhs:number;txHash?:string;explorerUrl?:string;momoReference?:string;customerWallet?:string;createdAt:string;merchantName?:string}
