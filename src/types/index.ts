...
export interface Invoice {id:string;merchantId:string;merchantName:string;merchantPhone:string;network:MobileMoneyNetwork;amountGhs:number;description:string;status:PaymentStatus;expiresAt:string;paymentUrl:string}
