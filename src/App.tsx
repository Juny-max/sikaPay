...
const router=createBrowserRouter([{element:<AppLayout/>,children:[
  ...
  {element:<ProtectedRoute/>,children:[{element:<MerchantLayout/>,children:[{path:'/merchant',element:<MerchantDashboard/>},{path:'/merchant/create-invoice',element:<CreateInvoicePage/>},{path:'/merchant/invoice/:invoiceId',element:<MerchantInvoicePage/>},{path:'/merchant/transactions',element:<MerchantTransactions/>},{path:'/merchant/settings',element:<MerchantSettings/>}]}]},
